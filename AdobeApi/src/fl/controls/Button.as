	...
	public class Button extends LabelButton implements IFocusManagerComponent {
		...
		override public function drawFocus(focused:Boolean):void {
			...
			if (focused) {
				...
				var focusPaddingValue:Number = focusPadding as Number;
				
				uiFocusRect.x = -focusPaddingValue;
				uiFocusRect.y = -focusPaddingValue;
				uiFocusRect.width = width + (focusPaddingValue*2);
				uiFocusRect.height = height + (focusPaddingValue*2);
			}
		}
