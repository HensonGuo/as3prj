package  utils.lib
{
	...
	public class FilterLib 
	{
		...
		public static var glow_orange : GlowFilter = new GlowFilter(ColorKey.bisque, 1, 1, 1, 3, 1);
		...
		public static var drop_bold : DropShadowFilter = new DropShadowFilter(1, 45, ColorKey.orange, 1, 3, 3, 1);
