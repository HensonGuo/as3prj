...
public class LightFilter extends FragmentFilter
{
	 ...
	 * @param	cy 灯光坐标
	 */
    public function LightFilter(cx:Number =0, cy:Number = 0)
    {
		this.mCenterX = cx;
		this.mCenterY = cy;
    }
	 ...
	 * 灯光R值
	 */
	public function get r():Number {return mR;}
	public function set r(value:Number):void {mR = value;}
	
	/**
	 * 灯光G值
	 */
	public function get g():Number {return mG;}
	public function set g(value:Number):void {mG = value;}
	
	/**
	 * 灯光B值
	 */
	public function get b():Number {return mB;}
	public function set b(value:Number):void {mB = value;}
	
	/**
	 * 灯光A值
	 */
	public function get a():Number {return mA;}
	public function set a(value:Number):void {mA = value;}
