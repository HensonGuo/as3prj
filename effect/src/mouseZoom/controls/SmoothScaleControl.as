package mouseZoom.controls
{
	...
	import mouseZoom.events.SmoothScaleControlEvent;
	
	[Event(name="actualContentOriginChange", type="com.tngar.mycroLib.mouseZoom.events.SmoothScaleControlEvent")]
	[Event(name="actualContentScaleChange", type="com.tngar.mycroLib.mouseZoom.events.SmoothScaleControlEvent")]
	/**
