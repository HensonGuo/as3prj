package mouseZoom.controls
{
	...
	import mouseZoom.events.ScaleControlEvent;
	
	[Event(name="contentChange", type="com.tngar.mycroLib.mouseZoom.events.ScaleControlEvent")]
	[Event(name="contentOriginChange", type="com.tngar.mycroLib.mouseZoom.events.ScaleControlEvent")]
	[Event(name="contentScaleChange", type="com.tngar.mycroLib.mouseZoom.events.ScaleControlEvent")]
	/**
