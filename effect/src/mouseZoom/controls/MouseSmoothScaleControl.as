package mouseZoom.controls
{
	import flash.display.Sprite;
	import flash.events.MouseEvent;
	import flash.geom.Point;
	
	import mouseZoom.events.MouseScaleEvent;

	[Event(name="mouseDragStart", type="com.tngar.mycroLib.mouseZoom.events.MouseScaleEvent")]
	[Event(name="mouseDragStop", type="com.tngar.mycroLib.mouseZoom.events.MouseScaleEvent")]
	[Event(name="mouseDragMove", type="com.tngar.mycroLib.mouseZoom.events.MouseScaleEvent")]
	[Event(name="mouseClickZoom", type="com.tngar.mycroLib.mouseZoom.events.MouseScaleEvent")]
	[Event(name="mouseWheelZoomIn", type="com.tngar.mycroLib.mouseZoom.events.MouseScaleEvent")]
	[Event(name="mouseWheelZoomOut", type="com.tngar.mycroLib.mouseZoom.events.MouseScaleEvent")]
	/**
