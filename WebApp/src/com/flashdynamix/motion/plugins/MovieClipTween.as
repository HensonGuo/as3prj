   ...
   public class MovieClipTween extends AbstractTween
   {
      ...
      override public function update(param1:Number) : void
      {
         ...
         for(_loc2_ in propNames)
         {
            ...
            else if(_loc2_ == "currentFrame")
            {
               this._current.gotoAndStop(Math.round(this._from.currentFrame * _loc3_ + this._to.currentFrame * param1));
            }
            else
            {
...
dynamic class MovieClipTweenObject extends Object
{
